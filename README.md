...
EcoCollect is a student-learning waste management API built with Node.js, Express.js, MariaDB/MySQL, JWT authentication, bcrypt password hashing, and Multer image uploads.
